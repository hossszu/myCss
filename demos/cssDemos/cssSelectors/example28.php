...
<html>
    ...
    <body>
        <pre class="styles"><code><?php echo htmlspecialchars('td[id*="1"] {
    border:solid 1px purple;
}') ?></code></pre>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="id 15" id="id-15-last">15 
                    <td class="en 15" id="en-15-last"><a target="_self"  href="http://szotar.sztaki.hu/dict_search.php?O=HUN&W=to+substitute" onClick="poptic(this.href); return false;">to substitute </a>
